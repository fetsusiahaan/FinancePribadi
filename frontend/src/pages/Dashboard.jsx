  ...
  return (
    <DashboardLayout title="Dashboard" actions={<MonthPicker value={month} onChange={setMonth} />}>
      ...
      {summaryQuery.isError && (
        <p role="alert" className="text-danger dark:text-dark-danger">
          Gagal memuat data dashboard. Periksa koneksi lalu muat ulang halaman.
        </p>
      )}
      ...
      {data && (
        <div className="space-y-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-md">
            ...
            <Card className="p-md">
              <h2 className="font-medium mb-md">Financial Health Score</h2>
            ...
            <Card className="p-md lg:col-span-2">
              <h2 className="font-medium mb-md">Cash Flow 6 Bulan</h2>
              ...
              {cashflowQuery.isError && (
                <p role="alert" className="text-body-sm text-danger dark:text-dark-danger">
                  Gagal memuat cash flow. Muat ulang halaman untuk mencoba lagi.
                </p>
              )}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-md">
            {/* Expense by category */}
            <Card className="p-md">
              <h2 className="font-medium mb-md">Pengeluaran per Kategori</h2>
