  ...
  return (
    <Card className="p-0 overflow-hidden">
      <div className="flex items-center gap-sm px-md py-sm border-b border-outline-variant/40 dark:border-dark-outline-variant/40">
        <span className="material-symbols-outlined text-[20px] text-on-surface-variant dark:text-dark-on-surface-variant" aria-hidden="true">
          {icon}
        </span>
    ...
    <DashboardLayout title="Profile">
      ...
      {user && (
        <div className="space-y-md">
          ...
          <SectionCard icon="notifications" title="Notifikasi">
